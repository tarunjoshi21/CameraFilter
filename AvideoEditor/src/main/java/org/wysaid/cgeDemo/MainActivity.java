...
public class MainActivity extends AppCompatActivity {
    ...
    private static final DemoClassDescription mDemos[] = new DemoClassDescription[]{
        //    new DemoClassDescription("BasicImageDemoActivity", "Basic Image Filter Demo"),
            new DemoClassDescription("ImageDemoActivity", "Image Filter"),
            new DemoClassDescription("CameraDemoActivity", "Camera Filter "),
         //   new DemoClassDescription("SimplePlayerDemoActivity", "Simple Player "),
          //  new DemoClassDescription("VideoPlayerDemoActivity", "Video Player "),
        //    new DemoClassDescription("FaceTrackingDemoActivity", "Face Tracking Demo"),
            new DemoClassDescription("TestCaseActivity", "Background filter")
    };
